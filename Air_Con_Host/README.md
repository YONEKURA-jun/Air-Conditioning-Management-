...
Windows デバイス通知機能を利用し、接続・切断された COM デバイスをリアルタイムに検知する機能を実装。
...
接続通知から取得したデバイスパスを基に、対象デバイスへ割り当てられた COM ポート番号を自動取得する機能を実装。
...
接続通知を受信した際に、接続デバイスの COM ポート情報を取得し、管理対象へ追加する機能を実装。
